...
#include <Fonts/FreeSerifBoldItalic4pt7b.h>
...
class MyFirstWatchFace : public Watchy{ //inherit and extend Watchy class
    public:
        void drawWatchFace(){ //override this method to customize how the watch face looks
          ...
          int batteryCurrent = (getBatteryVoltage()-3.3)/0.9;
          int batteryAngle = batteryCurrent * 180;
          double radBattery = ((batteryAngle + 180) * 71) / 4068.0;
